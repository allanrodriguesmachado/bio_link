...
{{--                    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 mb-6 mt-4">--}}
{{--                        <h2 class="text-xl font-bold text-slate-900 dark:text-white mb-2">{{$link->name}}</h2>--}}
{{--                        <p class="text-slate-600 dark:text-slate-400 mb-4">--}}
{{--                            Link: <a href="{{$link->url}}" class="text-indigo-600 dark:text-indigo-500 hover:underline">{{$link->url}}</a>--}}
{{--                        </p>--}}
